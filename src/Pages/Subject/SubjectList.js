...
export default function SubjectList() {
  ...
  const handleSearchName = () => {
    setPage(0);
    let newSubjectList = fullSubjectList;
    if (subjectName !== "")
      newSubjectList = newSubjectList.filter((subject) =>
        subject.subjectName.includes(subjectName)
      );
  ...
  return (
    <Grid container spacing={2} style={{ padding: "50px" }}>
      <Grid item xs={12}>
        <div style={{ fontSize: "48px" }}> Danh sách môn học </div>
      </Grid>
              ...
              {subjectList &&
                (rowsPerPage > 0
                  ...
                  <TableRow>
                    ...
                    <TableCell style={{ fontSize: "18px" }} align="center">
                      {subject.classList
                        ? Object.values(subject.classList).length
                        : 0}
                    </TableCell>
                    <TableCell align="center">
                      <a href={`${nextPagePathName}${subject.subjectId}`}>
                        <Typography
                          style={{ fontSize: "18px" }}
                          textAlign={"center"}
                        >
